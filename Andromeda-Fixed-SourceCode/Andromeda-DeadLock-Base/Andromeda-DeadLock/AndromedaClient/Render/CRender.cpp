...
void CRender::DrawLine(const ImVec2& Start, const ImVec2& End, const ImColor& Color, float thickness)
{
...
void CRender::DrawBox(const ImVec2& Min, const ImVec2& Max, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawOutlineBox(const ImVec2& Min, const ImVec2& Max, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawCoalBox(const ImVec2& Min, const ImVec2& Max, const ImColor& Color)
{
...
void CRender::DrawOutlineCoalBox(const ImVec2& Min, const ImVec2& Max, const ImColor& Color)
{
...
void CRender::DrawFillBox(const ImVec2& Min, const ImVec2& Max, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawRectFilledMultiColor(const ImVec2& Min, const ImVec2& Max, const ImU32 col_upr_left, const ImU32 col_upr_right,
...
void CRender::DrawCircle(const ImVec2& Center, float radius, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawCircleFilled(const ImVec2& Center, float radius, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawCircle3D(const Vector3& Center, float radius, const ImColor& Color)
{
...
void CRender::DrawTriangleFilled(const ImVec2& Center, const ImVec2& Pos1, const ImVec2& Pos2, const ImColor& Color)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
...
void CRender::DrawImage(ID3D11ShaderResourceView* pD3D11ShaderResourceView, const float x, const float y, const float w, const float h)
{
	auto pBackgroundDrawList = ImGui::GetBackgroundDrawList();
