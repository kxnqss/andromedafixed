...
void CFont::InitFont(IFW1Factory* pFW1Factory, std::wstring Name, float FontSize)
{
	m_FontSize = FontSize;
	m_FontName = Name;
...
void CFont::DrawString(int x, int y, ImColor Color, int Flags, const char* fmt, ...)
{
...
void CFont::DrawStringSize(int x, int y, ImColor Color, int Flags, float size, const char* fmt, ...)
{
	char Buffer[g_BufferSize] = {0};
...
FW1_RECTF CFont::GetStringLayoutRect(int Flags, FW1_RECTF* pRECTF, const char* fmt, ...)
{
	char Buffer[g_BufferSize] = {0};
